...
final class Operator
{
    ...
    public static function andOp(...$operands): CompositeOperator
    {
        return new CompositeOperator(self::MNEMONIC_COMPOSITE_AND, $operands);
    }

    public static function orOp(...$operands): CompositeOperator
    {
        return new CompositeOperator(self::MNEMONIC_COMPOSITE_OR, $operands);
    }

    public static function plus(...$operands): CompositeOperator
    {
        return new CompositeOperator(self::MNEMONIC_COMPOSITE_PLUS, $operands);
    }

    public static function mul(...$operands): CompositeOperator
    {
        return new CompositeOperator(self::MNEMONIC_COMPOSITE_MULTIPLY, $operands);
    }
    ...
    public static function sum($arg): FunctionCall
    {
        return self::call(FunctionCall::FUNCTION_SUM, [$arg]);
    }

    public static function avg($arg): FunctionCall
    {
        return self::call(FunctionCall::FUNCTION_AVG, [$arg]);
    }

    public static function min($arg): FunctionCall
    {
        return self::call(FunctionCall::FUNCTION_MIN, [$arg]);
    }

    public static function max($arg): FunctionCall
    {
        return self::call(FunctionCall::FUNCTION_MAX, [$arg]);
    }

    public static function call($funcName, array $args = []): FunctionCall
    {
        return new FunctionCall(self::MNEMONIC_CALL, $funcName, $args);
    }

    public static function minus($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_MINUS, $operand1, $operand2);
    }

    public static function div($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_DIVIDE, $operand1, $operand2);
    }

    public static function eq($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_EQ, $operand1, $operand2);
    }

    public static function neq($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_NEQ, $operand1, $operand2);
    }

    public static function gt($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_GT, $operand1, $operand2);
    }

    public static function gte($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_GTE, $operand1, $operand2);
    }

    public static function lt($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_LT, $operand1, $operand2);
    }

    public static function lte($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_LTE, $operand1, $operand2);
    }

    public static function in($operand1, $operand2): BinaryOperator
    {
        return new BinaryOperator(self::MNEMONIC_BINARY_INSET, $operand1, $operand2);
    }

    public static function notin($operand1, $operand2): BinaryOperator
    {
     ...
     */
    public static function match($operand1, $operand2): BinaryOperator
    {
     ...
     */
    public static function matchi($operand1, $operand2): BinaryOperator
    {
        if (\is_scalar($operand2)) {
            $operand2 = new Mask(self::MNEMONIC_CONST, $operand2);
        }
     ...
     * @see Operator::match() For pattern format
     */
    public static function notmatch($operand1, $operand2): BinaryOperator
    {
        if (\is_scalar($operand2)) {
            $operand2 = new Mask(self::MNEMONIC_CONST, $operand2);
        }
     ...
     * @see Operator::match() For pattern format
     */
    public static function notmatchi($operand1, $operand2): BinaryOperator
    {
        if (\is_scalar($operand2)) {
            $operand2 = new Mask(self::MNEMONIC_CONST, $operand2);
        }
     ...
     */
    public static function not(IExpression $operand): UnaryOperator
    {
        return new UnaryOperator(self::MNEMONIC_UNARY_NOT, $operand);
    }

    public static function isnull(IExpression $operand): UnaryOperator
    {
        return new UnaryOperator(self::MNEMONIC_UNARY_ISNULL, $operand);
    }

    public static function notnull(IExpression $operand): UnaryOperator
    {
        return new UnaryOperator(self::MNEMONIC_UNARY_NOTNULL, $operand);
    }

    public static function nullConst(): Constant
    {
        if (empty(self::$null)) {
    ...
    public static function falseConst(): Constant
    {
        if (empty(self::$false)) {
    ...
    public static function trueConst(): Constant
    {
        if (empty(self::$true)) {
    ...
    public static function constant($value, $type = Type::AUTO): Constant
    {
        if ($value === null) {
